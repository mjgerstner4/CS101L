...
##
## PROBLEM :
## A slot machine is needing to be created for Pierson Hall that has
## 3 reels with a range from 1 to 10. If the 3 numbers match then they
## will win 10 times their wager, if 2 of their numbers match then they
## will win 3 times their wager, but if none of their numbers match then
## they will lose.
...
if __name__ == "__main__":
    ...
    while playing:
        ...
        while True:  # Replace with condition for if they still have money.
            ...
            if bank == 0:
              print("You lost all", bank, "in", 0, "spins")
